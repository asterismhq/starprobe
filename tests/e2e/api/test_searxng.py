...
class TestSearXNGIntegration:
    ...
    def test_search_with_max_results(self, client):
        ...
        max_results = 3
        result = client.search("artificial intelligence", max_results=max_results)
    ...
    def test_search_handles_empty_query(self, client):
    ...
    def test_search_handles_invalid_query(self, client):
        """Test search with invalid query handles gracefully."""
        result = client.search("invalid_query_that_returns_no_results_12345")
